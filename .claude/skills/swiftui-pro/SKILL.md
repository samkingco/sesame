...
10. Check adherence to project-specific conventions using `references/conventions.md`.
...
- `references/conventions.md` - project-specific patterns (sheet modifiers, error handling, fonts).
